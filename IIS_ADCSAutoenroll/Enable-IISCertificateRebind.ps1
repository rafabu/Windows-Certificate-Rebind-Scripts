# taken from: Microsoft\Windows\CertificateServicesClient\IIS-AutoCertRebind
$schTask = @"
...
Register-ScheduledTask -xml ($schTask | Out-String) -TaskPath "\Microsoft\Windows\CertificateServicesClient\" -TaskName "IIS-AutoCertRebind" -Force
Write-Host (get-date -DisplayHint Time) registered scheduled task `"IIS-AutoCertRebind`"
